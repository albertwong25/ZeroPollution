...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form name="myform1" method="POST" action="single_game.php">
			<input type="hidden" id="pname" name="pname" value="<?php echo $_POST['pname']; ?>" />
		</form>
		<form name="myform2" method="POST" action="gameroom.php">
			<input type="hidden" id="pname" name="pname" value="<?php echo $_POST['pname']; ?>" />
		</form>
		...
		<div id="gameboard">
			...
			<div id="main">
				<table>
					...
					<tr>
						<td><button class="game-button" onclick="document.myform1.submit();">Single Player Game</button></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td><button class="game-button" onclick="document.myform2.submit();">Multiplayer Game</button></td>
					</tr>
				</table>
			</div>
