...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="application/javascript" src="scripts/single_ui.js"></script>
		<!-- Reference javascript -->
		<script type="application/javascript" src="scripts/single_game.js"></script>
		<!-- Reference javascript -->
		<script type="application/javascript" src="scripts/single_card.js"></script>
		<!-- Reference javascript -->
	...
	<body>
		<noscript>
			<p>
				Please enable JavaScript in your web browser. JavaScript must be enabled in order to play this game.
			</p>
		</noscript>
		<form name="myform" method="POST" action="main.php">
			<input type="hidden" id="pname" name="pname" value="<?php echo $_POST['pname']; ?>" />
		</form>
		<form name="myform3" method="POST" action="chatroom.php">
			<input type="hidden" id="pname" name="pname" value="<?php echo $_POST['pname']; ?>" />
		</form>
		<div id="gameboard">
			<div id="player1-CrystalArea" class="CrystalArea">
				<img class="Crystal" src="images/crystal.png" width="30" height="30">
		...
		<div id="control" class="clearfix">
			...
			<div class="right">
				<ul>
					<li><a href="#">Setting</a>
						<ul>
							<li><select name="player-selector" id="player-selector">
									<option value="4" selected="selected">4 Players</option>
								</select></li>
							<li><button class="menubutton" id="new-game">New Game</button></li>
